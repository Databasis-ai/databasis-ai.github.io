				...
				<div className="flex flex-wrap -m-4">
						...
						<div className="flex flex-col justify-between p-8 h-full bg-gray-900 rounded-3xl">
							...
							<div className="flex-initial">
								<div className="flex flex-wrap -m-2">
									<div className="w-full p-2"><a className="block w-full px-8 py-3.5 text-lg text-center text-gray-100 font-bold bg-gray-700 hover:bg-gray-900 focus:ring-4 focus:ring-gray-400 rounded-full" href="#">Get Started Now</a></div>
								</div>
							</div>
						</div>
					</div>
					<div className="w-full md:w-1/3 p-4">
						<div className="flex flex-col justify-between p-8 h-full bg-blue-500 rounded-3xl">
							...
							<div className="flex-initial">
								<div className="flex flex-wrap -m-2">
									<div className="w-full p-2"><a className="block w-full px-8 py-3.5 text-lg text-center text-blue-500 font-bold bg-white hover:bg-gray-200 focus:ring-4 focus:ring-gray-300 rounded-full" href="#">Get Started Now</a></div>
								</div>
							</div>
						</div>
					</div>
					<div className="w-full md:w-1/3 p-4">
						<div className="flex flex-col justify-between p-8 h-full bg-gray-900 rounded-3xl">
							<div className="flex-initial mb-6"><span className="inline-block mb-6 text-sm text-blue-500 font-bold uppercase tracking-widest">Pro</span>
								<h2 className="font-heading text-4xl text-white font-black tracking-tight"><span>Contact</span></h2>
								<p className="mb-8 text-sm text-gray-700 font-bold">Contact</p>
								<ul>
									<li className="flex items-center mb-4">
										<svg className="mr-2.5" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M4.16699 10.8333L7.50033 14.1667L15.8337 5.83333" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
										</svg>
										<p className="text-gray-100 font-bold">Unlimited Transactions</p>
									</li>
									<li className="flex items-center mb-4">
										<svg className="mr-2.5" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M4.16699 10.8333L7.50033 14.1667L15.8337 5.83333" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
										</svg>
										<p className="text-gray-100 font-bold">Unlimited Storage</p>
									</li>
									<li className="flex items-center mb-4">
										<svg className="mr-2.5" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M4.16699 10.8333L7.50033 14.1667L15.8337 5.83333" stroke="#3B82F6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
									...
									<li className="flex items-center">
										...
										<p className="text-gray-700 font-bold">Database Restoration</p>
									</li>
								</ul>
							</div>
							<div className="flex-initial">
