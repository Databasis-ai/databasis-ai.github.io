        ...
        <div className="flex flex-wrap lg:items-center -m-8">
          <div className="w-full md:w-1/2 p-8">
            <div className="md:max-w-md"><span className="inline-block mb-4 text-sm text-blue-500 font-bold uppercase tracking-widest">How it works</span>
              <h2 className="font-heading mb-6 text-4xl md:text-5xl text-gray-100 font-black tracking-tight">Time travel has never been so easy</h2>
              <p className="mb-5 text-gray-500 font-bold">Focus on what truly matters: unlocking time-powered insights for your data teams</p>
